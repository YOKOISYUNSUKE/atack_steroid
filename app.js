...
const QUESTIONS = [
  ...
  { id: 23, category: "骨粗鬆症", question: "長期ステロイド投与を行う時行う骨粗しょう症予防策のうち、骨吸収を抑制するのはどれですか。", options: ["カルシウムとビタミンDの積極的摂取　エルデカルシトール", "鉄剤", "抗ヒスタミン薬", "ビスホスホネート製剤（骨吸収抑制薬　リセドロン酸）"], correctIndex: 3 },
